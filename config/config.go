...
type Zammad struct {
	...
	TrunkPrefix  string `default:"0" desc:"Optional prefix to trim from the phone numbers received from the PBX. Normally necessary if calls come through a trunk line."`
